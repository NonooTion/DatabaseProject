    ...
    <el-container style="background-color: #e3e0f3; height: fit-content; min-height: 100%;">
        <div style="background-color: #faf7ff; margin-left: 10%; margin-right: 10%; width: 100%;">
            <div style="">
                ...
                <el-form ref="userInfoform" :model="userInfo" label-width="80px" labelPosition="top" style="margin-left: 5%; width: 50%;">
                    ...
                    <el-form-item >
                        <el-button type="primary" style="margin-left: 25%;" @click="handleUserInfoSave()">保存</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </div>
